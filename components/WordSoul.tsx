        ...
        {showWrong ? (
          ...
          >
            ...
            <button
              onClick={speakWord}
              disabled={isSpeaking}
              className={`inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[var(--accent-primary)] text-[var(--accent-primary)] hover:bg-[var(--accent-primary)]/10 transition-colors disabled:opacity-50 ${isSpeaking ? 'scale-[0.98] bg-[var(--accent-primary)]/10' : ''}`}
